...
func (o *CreateScanAllScheduleURL) WithBasePath(bp string) *CreateScanAllScheduleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateScanAllScheduleURL) Build() (*url.URL, error) {
	...
	var _path = "/system/scanAll/schedule"
...
func (o *CreateScanAllScheduleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateScanAllScheduleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateScanAllScheduleURL")
	}
