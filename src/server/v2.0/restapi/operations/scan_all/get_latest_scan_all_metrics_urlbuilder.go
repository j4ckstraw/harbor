...
func (o *GetLatestScanAllMetricsURL) WithBasePath(bp string) *GetLatestScanAllMetricsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetLatestScanAllMetricsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetLatestScanAllMetricsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetLatestScanAllMetricsURL")
	}
