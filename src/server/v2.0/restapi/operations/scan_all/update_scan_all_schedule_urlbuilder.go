...
func (o *UpdateScanAllScheduleURL) WithBasePath(bp string) *UpdateScanAllScheduleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *UpdateScanAllScheduleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on UpdateScanAllScheduleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on UpdateScanAllScheduleURL")
	}
