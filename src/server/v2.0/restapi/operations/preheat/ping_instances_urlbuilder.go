...
func (o *PingInstancesURL) Build() (*url.URL, error) {
	...
	var _path = "/p2p/preheat/instances/ping"
...
func (o *PingInstancesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PingInstancesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PingInstancesURL")
	}
