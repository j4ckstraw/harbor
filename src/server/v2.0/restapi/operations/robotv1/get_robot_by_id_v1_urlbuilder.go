...
func (o *GetRobotByIDV1URL) Build() (*url.URL, error) {
	...
	if projectNameOrID != "" {
		...
		return nil, errors.New("projectNameOrId is required on GetRobotByIDV1URL")
	}
	...
	if robotID != "" {
		...
		return nil, errors.New("robotId is required on GetRobotByIDV1URL")
	}
...
func (o *GetRobotByIDV1URL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRobotByIDV1URL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRobotByIDV1URL")
	}
