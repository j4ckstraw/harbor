...
func (o *DeleteRobotV1URL) Build() (*url.URL, error) {
	...
	if projectNameOrID != "" {
		...
		return nil, errors.New("projectNameOrId is required on DeleteRobotV1URL")
	}
	...
	if robotID != "" {
		...
		return nil, errors.New("robotId is required on DeleteRobotV1URL")
	}
...
func (o *DeleteRobotV1URL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteRobotV1URL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteRobotV1URL")
	}
