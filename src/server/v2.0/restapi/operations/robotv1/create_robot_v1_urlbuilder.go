...
func (o *CreateRobotV1URL) Build() (*url.URL, error) {
	...
	if projectNameOrID != "" {
		...
		return nil, errors.New("projectNameOrId is required on CreateRobotV1URL")
	}
...
func (o *CreateRobotV1URL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateRobotV1URL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateRobotV1URL")
	}
