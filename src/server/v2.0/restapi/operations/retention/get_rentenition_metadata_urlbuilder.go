...
func (o *GetRentenitionMetadataURL) WithBasePath(bp string) *GetRentenitionMetadataURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetRentenitionMetadataURL) Build() (*url.URL, error) {
	...
	var _path = "/retentions/metadatas"
...
func (o *GetRentenitionMetadataURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetRentenitionMetadataURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetRentenitionMetadataURL")
	}
